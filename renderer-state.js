...
(function () {
  ...
  window.SenseRendererState = {
    ...
    senseIaAutoIntervalId: null,
    senseIaHybridEnabled: false,
    senseIaHybridButtonOnly: true,
    senseIaHybridLastSide: "",
    senseIaHybridPrevOpinionSide: "",
